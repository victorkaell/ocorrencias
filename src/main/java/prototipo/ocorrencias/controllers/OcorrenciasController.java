...
public class OcorrenciasController {
	...
	public ModelAndView filtrarOcorrencia(@RequestParam("filtro") String filtro, HttpServletRequest request, RedirectAttributes attributes) {
		ModelAndView mv = new ModelAndView();
		List<Ocorrencia> ocorrencias = or.findAll();
		...
		for (int i = 0; i < ocorrencias.size(); i++) {
			...
			if (ocorrenciaNome.toUpperCase().contains(filtro.toUpperCase())) {
